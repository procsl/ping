...
public class OverrideableProcessor implements InitializingBean {
    ...
    @Around(value = "cn.procsl.ping.boot.common.advice.OverrideableProcessor.afterPropertiesSet() && @annotation(overrideable)", argNames = "joinPoint,overrideable")
    ...
    @Override
    @Pointcut("@annotation(cn.procsl.ping.boot.common.advice.Overrideable)")
