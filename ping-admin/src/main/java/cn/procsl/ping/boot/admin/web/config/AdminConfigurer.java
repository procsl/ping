...
import cn.procsl.ping.boot.admin.web.config.security.DynamicAuthorizationManager;
import cn.procsl.ping.boot.admin.web.config.security.LoginFailureHandler;
import cn.procsl.ping.boot.admin.web.config.security.LoginSuccessfulHandler;
import cn.procsl.ping.boot.admin.web.config.security.PermissionAccessDeniedHandler;
...
import static cn.procsl.ping.boot.admin.web.config.AdminConfigurer.*;
