...
import cn.procsl.ping.boot.rest.annotation.Accepted;
...
public class SimpleTypeHandler implements HandlerMethodReturnValueHandler, Ordered {
    ...
    final ViewNameMethodReturnValueHandler nameMethodReturnValueHandler;

    @Getter
    @Setter
    int order = 0;

    final RequestResponseBodyMethodProcessor process;
    ...
    public void handleReturnValue(Object returnValue, MethodParameter returnType, ModelAndViewContainer mavContainer, NativeWebRequest webRequest) throws Exception {
        ...
        do {
            ...
            if ("void".equals(returnType.getParameterType().getName()) || Void.class.isAssignableFrom(returnType.getParameterType())
