...
public class RestRequestMappingHandlerMapping extends RequestMappingHandlerMapping {
    ...
    protected RequestMappingInfo createRequestMappingInfo(Class clazz,
        ...
        boolean bool = (!CollectionUtils.isEmpty(registerHook)) &&
                (AnnotatedElementUtils.hasAnnotation(method, RestEndpoint.class) || AnnotatedElementUtils.hasAnnotation(clazz, RestEndpoint.class));
        if (bool) {
