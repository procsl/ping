...
final class JpaIdAndEntityRepositoryProcessor implements RepositoryProcessor {
    ...
    public void processor(ProcessingEnvironment env, RoundEnvironment roundEnv, TypeElement entity,
        ...
        TypeName params = ParameterizedTypeName.get(ClassName.get(repositoryElement), TypeName.get(entity.asType()), TypeName.get(idMirror));
