...
public final class PathUtils {
     ...
     * @return 返回标准化的路径
     */
    public static String standardize(String path, String dec) {
        if (isEmpty(path, dec)) {
            return dec;
        }
        path = path.trim();
     ...
     */
    public static boolean isRoot(String path, String des) {
        if (isEmpty(path, des)) {
            return true;
        }
     ...
     * @return 如果为空节点返回true
     */
    public static boolean isEmpty(String path, String dec) {
