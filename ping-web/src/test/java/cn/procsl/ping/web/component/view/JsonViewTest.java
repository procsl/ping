...
public class JsonViewTest {
    ...
    public void full() throws Exception {
        MockHttpServletRequestBuilder get = MockMvcRequestBuilders.get("/object/full.json");
        mockMvc.perform(get)
                .andDo(print())
    ...
    public void defaultFilter() throws Exception {
        MockHttpServletRequestBuilder get = MockMvcRequestBuilders.get("/object/full.json?field=two");
        mockMvc.perform(get)
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.two").exists())
    ...
    public void excludeFilter() throws Exception {
        MockHttpServletRequestBuilder get = MockMvcRequestBuilders.get("/object/full.json?field=two&pattern=exclude");
        mockMvc.perform(get)
                .andDo(print())
                .andExpect(status().isOk())
    ...
    public void includeFilter() throws Exception {
        MockHttpServletRequestBuilder get = MockMvcRequestBuilders.get("/object/full.json?field=two&pattern=include");
        mockMvc.perform(get)
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.two").exists())
    ...
    public void includeFilterMore() throws Exception {
        MockHttpServletRequestBuilder get = MockMvcRequestBuilders.get("/object/full.json?field=two,one,stacks.name&pattern=include");
        mockMvc.perform(get)
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.two").exists())
    ...
    public void excludeFilterMore() throws Exception {
        MockHttpServletRequestBuilder get = MockMvcRequestBuilders.get("/object/full.json?field=two,one,stacks.name,stacks.fuck,stack.echo,stack.fuck,three.list.name,three.array&pattern=exclude");
        mockMvc.perform(get)
                .andDo(print())
                .andExpect(status().isOk())
