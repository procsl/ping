...
public class AccountService {
    ...
    public Long check(@NotBlank String account, @NotBlank String password) throws BusinessException {
        Optional<Account> entity = this.jpaRepository.findOne(Example.of(new Account(account)));
